...
vi.mock("@/lib/hooks", async (importOriginal) => {
  ...
  return {
    ...
    useMcpConnections: () => ({
      data: [
        {
          id: "c1", name: "github", transport: "stdio", serverUrl: "", command: "", args: [],
          departmentId: null, connected: true, scopes: [], health: {},
          guardrailPresets: [], guardrailLibrary: null, hasValueSpec: false,
          pluginName: null, credentialType: null,
        },
      ],
    }),
  };
